    ...
    <AppLayout>
      ...
      <div className="min-h-full bg-gradient-to-br from-[#2d1b69] via-[#6d28d9] to-[#be185d] p-6 rounded-xl space-y-6 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-[#1d4ed8] drop-shadow-lg">SweatSmart Climate Alerts</h1>
              <p className="text-[#1e40af] mt-1 text-base">Real-time weather monitoring and personalized alerts</p>
            </div>
            {location && (
              <Button
