...
const StatPill = ({ emoji, value, label, gradient }: {
  ...
  <div className={`flex flex-col items-center justify-center px-3 py-2.5 rounded-2xl ${gradient} flex-1`}>
      ...
      <div className="max-w-lg mx-auto pb-10">
        ...
        <div className="bg-gradient-to-br from-violet-600 via-purple-500 to-pink-500 px-6 pt-8 pb-14 rounded-b-[2.5rem] shadow-lg shadow-purple-200">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <h1 className="text-white text-lg font-black tracking-tight leading-tight text-center flex-1">
          ...
          <div className="grid grid-cols-4 gap-2">
            ...
            <StatPill emoji="🗓️" value={thisWeek} label="This week" gradient="bg-white/20 backdrop-blur-sm" />
            <StatPill emoji="⚡" value={avgSeverity} label="Avg HDSS" gradient="bg-white/20 backdrop-blur-sm" />
            <StatPill emoji="🔥" value={topTrigger.length > 8 ? topTrigger.slice(0, 8) + "…" : topTrigger} label="Top trigger" gradient="bg-white/20 backdrop-blur-sm" />
          </div>
        </div>
