...
const InsightCard: React.FC<InsightCardProps> = ({
  ...
  const handleExportForClinician = async () => {
    try {
      ...
      pdf.text('HidroAlly Clinical Insight Report', margin, yPosition);
      yPosition += 15;
      ...
      pdf.text('This report is for clinical reference only. Generated by HidroAlly App.', margin, yPosition);
