      ...
      <div className="bg-gradient-to-r from-violet-600 via-purple-500 to-pink-500 shadow-lg shadow-purple-200/50">
        <div className="container flex h-16 items-center justify-between px-4">
          ...
          >
            ...
            <div className="bg-white/90 rounded-xl px-2.5 py-1">
              <h1 className="text-[#1d4ed8] text-xl font-black tracking-tight leading-none">
                SweatSmart
              </h1>
              <p className="text-[#1e40af] text-xs font-bold leading-none mt-0.5">
